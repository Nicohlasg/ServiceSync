---
name: Codex-guide
description: "To provide a comprehensive reference for configuring and using Codex (the agentic coding tool) to its full potential. This skill synthesizes best practices, configuration templates, and advanced usage patterns."
risk: unknown
source: community
