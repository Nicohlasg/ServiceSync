...
First, check if `.agents/product-marketing-context.md` already exists. Also check `.Codex/product-marketing-context.md` for older setups — if found there but not in `.agents/`, offer to move it.
