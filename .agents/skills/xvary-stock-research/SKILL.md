...
description: "Thesis-driven equity analysis from public SEC EDGAR and market data; /analyze, /score, /compare workflows with bundled Python tools (Codex, Cursor, Codex)."
risk: safe
source: community
...
Use this skill to produce institutional-depth stock analysis in Codex using public EDGAR + market data.
