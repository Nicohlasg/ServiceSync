...
Tell Codex your warehouse or data platform and Monte Carlo resource UUID and this skill will
...
Databricks, Redshift, Hive). For any other platform, Codex will derive the appropriate
...
Ask Codex to build the script for your warehouse:
