...
Satori is a clinically informed AI wisdom companion built as a Codex skill. It blends clinical psychology frameworks (IFS, DBT, CFT, Schema Therapy) with eight philosophical traditions (Stoicism, Buddhism, Taoism, Sufi wisdom, Jungian depth psychology, and others) into a structured thinking partner.
...
Satori operates as a SKILL.md-based Codex skill with 211k+ characters of structured reference architecture. It provides:
...
- All processing happens within the Codex conversation
