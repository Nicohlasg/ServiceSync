...
tools: [Codex, cursor, gemini, windsurf]
---
...
| **Multi-AI workflows** | Universal context that works across Codex, Cursor, Gemini, Windsurf |
...
Expert setup of Codex-faf-mcp with 33 tools:
```json
{
  "mcpServers": {
    "faf": {
      "command": "npx",
      "args": ["-y", "Codex-faf-mcp@latest"]
    }
  }
}
```
...
faf enhance --model Codex --focus completeness
```
...
- `Codex-faf-mcp` - 33 tools, 391 tests
