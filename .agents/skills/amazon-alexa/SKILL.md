---
name: amazon-alexa
description: "Integracao completa com Amazon Alexa para criar skills de voz inteligentes, transformar Alexa em assistente com Codex como cerebro (projeto Auri) e integrar com AWS ecosystem (Lambda, DynamoDB, Polly, Transcribe, Lex, Smart Home)."
risk: safe
source: community
...
# AMAZON ALEXA — Voz Inteligente com Codex

## Overview

Integracao completa com Amazon Alexa para criar skills de voz inteligentes, transformar Alexa em assistente com Codex como cerebro (projeto Auri) e integrar com AWS ecosystem (Lambda, DynamoDB, Polly, Transcribe, Lex, Smart Home).
...
> Codex como LLM backend, com voz neural, memoria persistente e
...
```
[Alexa Device] → [Alexa Cloud] → [AWS Lambda] → [Codex API]
...
| LLM | Codex API (Anthropic) | Inteligencia e respostas |
...
[ ] ChatIntent handler com Codex integrado
...
- Codex + Alexa guide: https://www.anthropic.com/news/Codex-and-alexa-plus
