...
- Anthropic SDK - When: Codex-based agents Note: Beta tool runner handles most complexity
...
"""
Examples show Codex concrete patterns that schemas can't express.
...
- Executes tools when Codex calls them
...
"""
By default, Codex can call multiple tools in one response.
This dramatically reduces latency for independent operations.
"""

## Handling Parallel Results
"""
# Codex returns multiple tool_use blocks:
response.content = [
