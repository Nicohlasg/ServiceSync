---
name: skill-check
description: "Validate Codex skills against the agentskills specification. Catches structural, semantic, and naming issues before users do."
...
tools: [Codex, cursor, windsurf, codex-cli]
license: MIT
...
```
User: check my skill at ~/.Codex/skills/weekly-report/SKILL.md
...
```
User: skillcheck ~/.Codex/skills/processing-pdfs/SKILL.md
