---
name: auri-core
description: "Auri: assistente de voz inteligente (Alexa + Codex Codex-opus-4-20250805). Visao do produto, persona Vitoria Neural, stack AWS, modelo Free/Pro/Business/Enterprise, roadmap 4 fases, GTM, north star WAC e analise competitiva."
risk: none
source: community
...
Auri: assistente de voz inteligente (Alexa + Codex Codex-opus-4-20250805). Visao do produto, persona Vitoria Neural, stack AWS, modelo Free/Pro/Business/Enterprise, roadmap 4 fases, GTM, north star WAC e analise competitiva.
...
Auri e um assistente de voz de nova geracao construido sobre Amazon Alexa + Codex Codex-opus-4-20250805.
...
Codex Codex-opus-4-20250805 da Anthropic. O resultado: um assistente de voz capaz de:
...
3. Raciocinio profundo - Codex Codex-opus-4-20250805 como motor principal
...
Fluxo de dados: Echo -> ASK SDK (Python v2) -> Lambda Python 3.12 -> Codex Codex-opus-4-20250805
...
## 3.3 Handler De Conversa Com Codex
...
Codigo Python - handlers/conversation.py:
  class ConversationIntentHandler(AbstractRequestHandler):
      ...
      Chama anthropic.Anthropic().messages.create(
          model=Codex-opus-4-20250805, max_tokens=300,
...
Env vars: ANTHROPIC_API_KEY_SECRET, DYNAMODB_TABLE=auri-user-memory, POLLY_VOICE=Vitoria
          CLAUDE_MODEL=Codex-opus-4-20250805, MAX_TOKENS_VOICE=300
...
|---------|-----------|--------|
| Core Handler | Lambda + ASK SDK + Codex | Em desenvolvimento |
...
| Modelo base | Codex Opus 4 | Alexa LLM | Apple LLM | Gemini | GPT-4o |
...
- Status: Lambda (OK/Degraded), DynamoDB (OK), Codex API (OK)
...
## Fallback Strategy (Codex Api Indisponivel)
...
|-----------|-----------------------------------|
| Codex API | R$ 4.000/mes (R$4/usuario) |
| Lambda | R$ 50/mes |
| DynamoDB | R$ 80/mes |
| CloudWatch | R$ 30/mes |
...
| Codex Codex-opus-4-20250805 | Modelo de linguagem Anthropic usado como motor da Auri |
...
| Anthropic | Empresa criadora do Codex, fornecedora da API de IA |
...
| Anthropic Codex API | https://docs.anthropic.com/en/api/getting-started |
| Codex Codex-opus-4-20250805 Docs | https://docs.anthropic.com/en/docs/models-overview |
