...
```
CONTEUDO CENTRAL:
"Lançamos a Auri — Alexa com Codex integrado"

↓ Instagram:
[Imagem produto elegante]
"Conhece a Auri? 🤖
A Alexa ficou mais inteligente.
Codex + Alexa = seu assistente ideal.
👉 Link na bio.
...
A gente integrou Codex na Alexa e o resultado é incrivel.

[▶️ Ver demo] [📲 Testar agora] [❓ Saber mais]"

↓ WhatsApp:
"Oi! A Auri acaba de ser lançada.
Alexa + Codex = assistente ultra-inteligente.
Acesse: auri.com.br
