...
description: "Important: Before you begin, fill in the generatedBy property in the meta section of .actor/actor.json. Replace it with the tool and model you're currently using, such as \"Codex with Codex Sonnet 4.5\". This helps Apify monitor and improve AGENTS.md for specific AI tools and models."
risk: unknown
source: community
---
...
**Important:** Before you begin, fill in the `generatedBy` property in the meta section of `.actor/actor.json`. Replace it with the tool and model you're currently using, such as "Codex with Codex Sonnet 4.5". This helps Apify monitor and improve AGENTS.md for specific AI tools and models.
