...
(like dropdowns and scrollbars) might be tricky for Codex to manipulate."
...
simple_model = "Codex-haiku-..."  # For "is task done?"
complex_model = "Codex-sonnet-..."  # For complex reasoning
```
...
Codex's context window is finite. When full:
...
async def tiered_model_selection(task_complexity: str):
    ...
    if task_complexity == "simple":
        return "Codex-haiku-..."  # Cheapest
    elif task_complexity == "medium":
        return "Codex-sonnet-4-20250514"  # Balanced
    else:
        return "Codex-opus-4-5-..."  # Best but expensive
```
...
- User mentions or implies: Codex computer
