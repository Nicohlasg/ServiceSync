...
- Official providers: OpenAI, Anthropic Codex, Google Gemini
...
// (e.g., OpenAI, Anthropic Codex, or Google Gemini connector)
...
// Note: Requires an AI provider plugin (OpenAI, Codex, or Gemini) to be installed and configured
...
$response = wp_ai_client_prompt('Summarize this content.')
    ->using_model_preference('gpt-4', 'Codex-3-opus', 'gemini-2-pro')
    ->generate_text();
