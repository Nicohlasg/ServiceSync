...
".join(context_parts)
        response = client.messages.create(
            model="Codex-opus-4-20250805", max_tokens=1024,
...
## Estimativa De Custos Codex

PRICING = {
        "Codex-opus-4-20250805": {"input": 15.00, "output": 75.00},
        "Codex-sonnet-4-5": {"input": 3.00, "output": 15.00},
        "Codex-haiku-3-5": {"input": 0.80, "output": 4.00},
    }
...
"
        ...
        response = client.messages.create(
            model="Codex-haiku-3-5", max_tokens=1024,
