---
name: skill-improver
description: "Iteratively improve a Codex skill using the skill-reviewer agent until it meets quality standards. Use when improving a skill with multiple quality issues, iterating on a new skill until it meets standards, or automated fix-review cycles instead of manual editing."
risk: unknown
source: community
---
