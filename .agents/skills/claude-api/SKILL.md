...
- Use when building with the Codex API, Anthropic SDKs, or the Agent SDK.
- Use when code imports `anthropic`, `@anthropic-ai/sdk`, or related Codex SDK packages.
- Do not use for general coding work unrelated to Codex integrations.
