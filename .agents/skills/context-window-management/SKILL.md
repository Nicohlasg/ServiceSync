...
- Codex API - 200K+ context with caching support
...
const TIERS: ContextTier[] = [
    { maxTokens: 8000, strategy: 'full', model: 'Codex-3-haiku' },
    { maxTokens: 32000, strategy: 'full', model: 'Codex-3-5-sonnet' },
    { maxTokens: 100000, strategy: 'summarize', model: 'Codex-3-5-sonnet' },
    { maxTokens: Infinity, strategy: 'rag', model: 'Codex-3-5-sonnet' }
];
