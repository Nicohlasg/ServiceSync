    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className={`absolute z-[9999] min-w-[8rem] overflow-hidden rounded-md border border-slate-700/50 bg-slate-900 text-slate-100 p-1 shadow-md shadow-[0_2px_8px_rgba(0,0,0,0.05)] dark:shadow-[0_2px_10px_rgba(0,0,0,0.3)] ${positionClasses} ${alignmentClasses} ${className}`}
          role="menu"
...
export function DropdownSeparator({ className = "" }: DropdownSeparatorProps) {
  return (
    <div className={`mx-1 my-1 h-px bg-slate-800 ${className}`} role="separator" />
  )
}
