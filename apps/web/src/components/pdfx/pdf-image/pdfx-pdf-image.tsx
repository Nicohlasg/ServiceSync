...
import { Image as PDFImage, Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
import type { Style } from '@react-pdf/types';
import { theme as defaultPdfxTheme, type PdfxTheme } from '../../../lib/pdfx-theme';
...
export function PdfImage({
  ...
  const content = (
    <View style={styles.container}>
      <PDFImage src={src} style={imageStyles} />
