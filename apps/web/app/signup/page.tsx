                    ...
                    <form onSubmit={handleSignup} className="relative z-10">
                        <CardContent className="space-y-4">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full flex items-center justify-center gap-2 h-12 rounded-xl bg-white/5 border border-white/10 text-white text-sm font-bold hover:bg-white/10 active:scale-[0.98] transition-all disabled:opacity-50"
                            >
                            ...
                            <div className="flex items-center gap-3 w-full">
                                ...
                                <span className="text-xs text-zinc-500 font-bold uppercase tracking-widest">or sign up with email</span>
                                <div className="flex-1 h-px bg-white/10" />
                            </div>
